...
namespace KubernetesExtension.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeleteDeployment : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x1026;
        ...
        /// </summary>
        public static DeleteDeployment Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            _deployment.DeleteDeployment(_package);
